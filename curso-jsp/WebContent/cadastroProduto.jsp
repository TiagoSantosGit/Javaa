...
<link
  rel=stylesheet
  href="resourse/css/cadastro.css">
<link
  rel="shortcut icon"
...
<body>
  <a href="acessoliberado.jsp"><img
    src="resourse/img/home.jpg"
    alt="Início"
    title="Início"
    width="30px"
    height="30px"></a>
  <a href="index.jsp"><img
    src="resourse/img/exit.jpg"
    alt="Sair"
    title="Sair"
    width="30px"
    height="30px"></a>
      ...
      <table>
        <tr>
          ...
          <td><input
            ...
            id="codigo"
            name="codigo"
            value="${produt.codigo}"></td>
          <td>Nome:</td>
          <td><input
            type="text"
            id="nome"
            name="nome"
            value="${produt.nome}"></td>
        </tr>
        <tr>
          <td>Quantidade:</td>
          <td><input
        ...
        <tr>
          <td><input
            ...
            type="submit"
            value="Cancelar"
            onclick="document.getElementById('formProdut').action = 'salvarProduto?acao=reset'"></td>
        </tr>
      </table>
    </ul>
  </form>
