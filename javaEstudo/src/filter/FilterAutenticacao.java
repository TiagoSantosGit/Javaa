...
// faz alguma coisa quando a aplica��o e derrubada
    @Override
    public void destroy() {
    }

// imtercepta todas as requisi��es
    @Override
	...
	if (userLogado == null && !urlParaAutenticar.equalsIgnoreCase("/pages/ServletAutenticacao")) { // usuario n�o
												       // logado
