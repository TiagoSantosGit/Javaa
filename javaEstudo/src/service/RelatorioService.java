...
public class RelatorioService implements Serializable {
	...
	public String gerarRelatorio(List<?> listaDataBeanCollection, HashMap hashMap, String nomeRelatorioJasper,
		...
		/* Fornece o caminho at� a pasta que contem os relat�rios .jasper */
		...
		/* Gera par�metros SUBREPORT_DIR com o caminho f�sico para subreport */
		...
		/* Remove o arquivo do servidor ap�s ser feito no download */
